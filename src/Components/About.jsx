...
function About () {
  ...
  <div className='mt-12'>
    <h1 className='text-2xl font-semibold text-green-800'>Education and Training</h1>
  ...
  <div className='mt-12'>
    <h1 className='text-2xl font-semibold text-green-800'>Skills and Expertise</h1>
    <ul className='text-xl space-y-3 mt-4'>
      ...
      <li className='flex items-center'><SiExpress className='mr-2 text-gray-600' /> Express.js</li>
  ...
  <div className='mt-12'>
    <h1 className='text-2xl font-semibold text-green-800'>Mission and Statement</h1>
  ...
  <div className='mt-12'>
    <h1 className='text-2xl font-semibold text-green-800'>Hobbies</h1>
    <p className='text-lg mt-4 text-gray-700 leading-relaxed'>
